...
typedef struct __attribute__((packed))
{
    ...
    uint8_t  state;                /* offset 65,  1 byte   (0 = idle, 1 = charging, 2 = discharging, 3 = fault) */

    /* --- padding to reach exactly 76 bytes --- */
    uint8_t _reserved[10];         /* offset 66, 10 bytes */
